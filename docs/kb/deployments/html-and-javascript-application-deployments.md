...
2. Configure some project variables to match the JavaScript shown above. *You can use these values or any other values you wish - we've chosen to show a [complex expression](/docs/projects/variables/variable-substitutions.md) including an [Octopus System Variable](/docs/projects/variables/system-variables.md).*
